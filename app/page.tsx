  ...
  return (
    <Layout>
      <section className={Page.section}>
        <h2 className={Page.heading}>最近の釣果</h2>
        <Post />
      </section>

      <section id="category" className={`${Page.section} ${wrapper['l-wrapper__over']}`}>
        <div className={wrapper['l-wrapper__outer']}>
          <div className={wrapper['l-wrapper__inner']}>
            <h2 className={Page.heading}>魚種</h2>
          </div>
        </div>
      </section>
    </Layout>
...
//   return (
//     <Layout>
//       <h2 className={styles.heading}>釣果</h2>
//     </Layout>
//   )
// }
